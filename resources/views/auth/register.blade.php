    ...
    <div class="row  justify-content-center">
        <div class="col-md-4 mt-5 border-0">
            <div class="card  bg-white border-0 shadow-sm">
                <div class="card-header border-0 text-muted" style="font-family: 'UnifrakturCook';font-size: 20px;color: #111111e0;"><i class="bi bi-person-fill shadow-sm  rounded-pill px-2 py-1"></i> {{ __('Creer un compte') }}</div>
